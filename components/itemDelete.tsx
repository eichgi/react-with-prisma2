...
const ItemDelete = (
  ...
  }] = useMutation(isFeed ? DELETE_FEED_MUTATION : DELETE_BUNDLE_MUTATION);
  ...
  return (
    <>
                ...
                <div className="absolute inset-0 bg-gray-500 opacity-75">
                  ...
                  <div role="dialog" aria-modal="true" aria-labelledby="modal-headline"
                    ...
                    <div className="bg-white px-4 pt-5 pb-4 sm:p-6 sm:pb-4">
                      <h3 className="text-lg font-medium">Are you sure you want to delete
                        this {isFeed ? 'feed' : 'bundle'}?</h3>
                    </div>

                    <div className="bg-gray-50 px-4 py-3 sm:px-6 sm:flex sm:flex-row-reverse">
                      <span className="flex w-full rounded-md sm:ml-3 sm:w-auto">
                        <button className="font-bold py-2 px-6 rounded text-white bg-red-500 text-white w-full"
                                type="button" onClick={(e) => onDeleteHandler(e)}>
                          Delete
                        </button>
                      </span>
                      <span className="flex w-full rounded-md sm:ml-3 sm:w-auto">
                        <button
                          className="font-bold py-2 px-6 rounded text-white bg-white text-gray-700 border-4 border-gray-300 w-full"
      ...
      <div className="flex col-span 1 py-2 px-1 z-10" onClick={(e) => {
        e.preventDefault();
        setVisibility(true);
      }}>
