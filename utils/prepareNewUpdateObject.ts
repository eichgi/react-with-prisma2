...
export const prepareNewUpdateObject = (queriedItem, currentItem, isFeed, isEditing) => {
  ...
  const queriedData = genNestedItem(queriedItem);
  //console.log(currentData, queriedData);
  ...
  //console.log(disconnectedTags, connectedTags);
